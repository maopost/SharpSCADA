...
namespace BatchCoreService
{
    ...
    public class DAService : IDataServer, IAlarmServer
    {
       // const int PORT = 6543;
        ...
        #region Find A Usable Port
        private int FreeTcpPort()
        {
            TcpListener newListener = new TcpListener(IPAddress.Loopback, 0);
            newListener.Start();
            int port = ((IPEndPoint)newListener.LocalEndpoint).Port;
            newListener.Stop();
            return port;
        }
        #endregion
        ...
        void InitHost()
        {
            ...
            IPEndPoint LocalPort = new IPEndPoint(IPAddress.Any, FreeTcpPort());
